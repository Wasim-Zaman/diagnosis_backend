...
router.get(
  "/get-user-service-bookings",
  isAuth,
  serviceBookingController.getUserServiceBookings
);
...
router.put(
  "/update-service-booking/:id",
  isAdmin,
  serviceBookingController.updateServiceBookingById
);

// Update service booking status
router.put(
  "/update-service-booking-status/:id",
  isAdmin,
  serviceBookingController.updateServiceBookingStatus
);

// Delete service booking by ID
router.delete(
  "/delete-service-booking/:id",
  isAdmin,
  serviceBookingController.deleteServiceBookingById
);
